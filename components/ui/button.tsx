...
// Add animation styles to the buttonVariants cva function above
// The animation is already included in the base styles:
// "transition-colors" handles color animations
// Additional animations can be added by modifying the buttonVariants definition